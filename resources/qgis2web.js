...
map.getView().fit([12537896.597155, -888338.200214, 12541943.486434, -886281.729743], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Persebaran Rombengan di Kelurahan Blimbing</h2>';
        return titleElement;
    })(),
